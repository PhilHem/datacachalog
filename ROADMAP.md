...
- [x] Version resolution: `as_of=datetime` finds closest version at or before that time
- [x] Version-aware cache key strategy (date-based paths: `2024-12-14T093000.parquet`)
