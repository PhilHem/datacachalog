...
class TestCatalogS3Fetch:
    ...
    def test_fetch_uses_cache_when_not_stale(
        self, s3_client: Any, tmp_path: Path
    ) -> None:
    ...
    def test_fetch_redownloads_when_s3_changes(
        self, s3_client: Any, tmp_path: Path
    ) -> None:
...
class TestCatalogS3Invalidate:
    ...
    def test_invalidate_forces_redownload(self, s3_client: Any, tmp_path: Path) -> None:
